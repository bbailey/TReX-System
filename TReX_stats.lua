...
TReX.stats.prompt_options={
	...
	mono = function () if table.contains({TReX.serverside.items.room}, "a monolith sigil") then return "<brown>-MONO- " else return "" end end,
	...
	lightwall = function () if table.contains({TReX.serverside.items.room}, "a lightwall") then return "<white>{<red>[<white>LW<red>]<white>}" else return "" end end,
	heldbreath = function () if t.def.heldbreath then return "<sky_blue>[<white>B<sky_blue>]" else return "" end end,
	--ferocity = function () if trx.snb.ferocity >= 1 then return "("..trx.snb.ferocity..")" else return "" end end,
