...
echo("\n")
echo("\n - ") echoLink("Roar", "clearCmdLine() appendCmdLine'troar '", "system login TREX roar") cecho("<white>: "..t.serverside.settings.roar.."", false)
echo("\n - ") echoLink("Pipes", "clearCmdLine() appendCmdLine'gagpipes '", "gag relighting pipes") cecho("<white>: "..t.serverside.settings.gag_pipes.."", false)
echo("\n - ") echoLink("Chime", "clearCmdLine() appendCmdLine'ttells '", "toggle incoming tells chime") cecho("<white>: "..t.serverside.settings.tells.."", false)
echo("\n - ") echoLink("Sip Health", "clearCmdLine() appendCmdLine'sip_health_at '", "sip health at what percent") cecho("<white>: "..t.serverside["settings_default"].sip_health_at.." %", false)
echo("\n - ") echoLink("Sip Mana", "clearCmdLine() appendCmdLine'sip_mana_at '", "sip mana at what percent") cecho("<white>: "..t.serverside["settings_default"].sip_mana_at.." %", false)
echo("\n - ") echoLink("Moss Health", "clearCmdLine() appendCmdLine'moss_health_at '", "moss health at what percent") cecho("<white>: "..t.serverside["settings_default"].moss_health_at.." %", false)
echo("\n - ") echoLink("Moss Mana", "clearCmdLine() appendCmdLine'moss_mana_at '", "moss mana at what percent") cecho("<white>: "..t.serverside["settings_default"].moss_mana_at.." %", false)
echo("\n - ") echoLink("CMDSEP", "clearCmdLine() appendCmdLine'cmdsep '", "set command separator to") cecho("<white>: "..t.serverside.settings_dict.cmdsep.."", false)
echo("\n - ") echoLink("Fractures", "clearCmdLine() appendCmdLine'set_fractures '", "apply to fractures at what percent") cecho("<white>: "..t.serverside["settings_default"].fractures.." %", false)
echo("\n - ") echoLink("Clotting", "clearCmdLine() appendCmdLine'clot_at '", "clot at what # bleeding") cecho("<white>: "..t.serverside["settings_default"].clot_at.." bleeding", false)
echo("\n - ") echoLink("Diagnose", "clearCmdLine() appendCmdLine'unknown_diag_at '", "system diagnose at # unknowns") cecho("<white>: "..t.config["settings_system"].diag_at.." unknown", false)
echo"\n"
